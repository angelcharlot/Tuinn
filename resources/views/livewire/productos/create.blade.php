...
<form class=" " wire:submit.prevent="save">
    ...
    ">
        ...
        <div class="text-left">
            ...
            <input type="text" placeholder="cañan Cruz campo" name="nombre" id="nombre"
        ...
        <div class="text-left col-span-2">
            ...
            <input type="text" placeholder="contenido alcohólico de 5,9% en volumen. De color dorado intenso y aroma afrutado, capaz de transformar los momentos cotidianos en instantes cruciales. Con un amargor moderado y aromático, coronada por una espuma de color blanco roto." name="descrip" id="descrip"
                class="block  w-11/12 mx-1 my-1 bg-gray-50 rounded text-sm border borde-gray-400 focus:outline-none focus:shadow-md shadow-lg h-10 px-2 focus:bg-gray-100 focus:border-gray-600">
        </div>
        <div class="text-left">
            <label class="text-xs text-gray-700 mx-1 " for="">precio de compra</label>
            <input type="num" placeholder="1.00" name="p_compra" id="p_compra"
                class="block  w-11/12 mx-1 my-1 bg-gray-50 rounded text-sm border borde-gray-400 focus:outline-none focus:shadow-md shadow-lg h-10 px-2 focus:bg-gray-100 focus:border-gray-600">
        </div>
        <div class="text-left">
            <label class="text-xs text-gray-700 mx-1 " for="">precio de venta</label>
            <input type="text" placeholder="1.20" name="p_venta" id="p-venta"
                class="block  w-11/12 mx-1 my-1 bg-gray-50 rounded text-sm border borde-gray-400 focus:outline-none focus:shadow-md shadow-lg h-10 px-2 focus:bg-gray-100 focus:border-gray-600">
        </div>
        <div class="text-left">
            <label class="text-xs text-gray-700 mx-1 " for="">peso(gramos(g))</label>
            <input type="text" placeholder="100" id="peso" name="peso"
                class="block  w-11/12 mx-1 my-1 bg-gray-50 rounded text-sm border borde-gray-400 focus:outline-none focus:shadow-md shadow-lg h-10 px-2 focus:bg-gray-100 focus:border-gray-600">
        </div>
        <div class="text-left">
        ...
        <div class="text-left">
            <label class="text-xs text-gray-700 mx-1 " for="">volumen(centimetro cubicos(Cm<sub>2</sub>))</label>
            <input type="text" placeholder="1" id="volumen" name="volumen"
                class="block  w-11/12 mx-1 my-1 bg-gray-50 rounded text-sm border borde-gray-400 focus:outline-none focus:shadow-md shadow-lg h-10 px-2 focus:bg-gray-100 focus:border-gray-600">
        </div>
        <div>
        ...
        <div class="text-left col-span-2">
            ...
            <div class="subir_foto">
                <button class="block  w-11/12 mx-1 my-1 bg-gray-50 rounded text-sm border borde-gray-400 focus:outline-none focus:shadow-md shadow-lg h-10 px-2 focus:bg-gray-100 focus:border-gray-600">Subir Archivo</button>
        ...
        <div class="md:m-2 m-1 ">
            ...
            @else
            <img class="h-16 mx-auto w-16 object-cover rounded-lg border border-gray-200"
            src="{{asset('images/icons8-cubiertos-100.png')}}"
            alt="Current profile photo" />
            @endif
            ...
            <div class="w-auto pl-3 text-center align-middle">
                <div class="pt-5">
                    <button wire:click="store()"
                        class="px-3 py-2 bg-purple-200 text-purple-500 hover:bg-purple-500 hover:text-purple-100 rounded">Agregar
                        contacto</button>
