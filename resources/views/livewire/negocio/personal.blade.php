        ...
        <table class="border-collapse table-auto  w-full text-xs md:text-sm ">
            <thead>
                ...
                <tr class="h-4 md:h-16 bg-gradient-to-b from-gray-50 to-gray-200">
                    ...
                    <th
                        class="  font-medium  p-2 md:p-4 pr-8 pt-0 pb-3 text-slate-400 text-left hidden md:table-cell truncate">
                        Email</th>
                    <th
                        class="  font-medium  p-2 md:p-4 pr-8 pt-0 pb-3 text-slate-400 text-left hidden md:table-cell truncate">
                        rol</th>
                    <th class="  font-medium  p-2 md:p-4 pr-8 pt-0 pb-3 text-slate-400 text-left hidden md:table-cell truncate"
                        width="150px">
                        Acciones</th>
                </tr>
            ...
            @forelse ($usuarios as $usuario)
                <tbody class="bg-white border-b-2 border-slate-100">
                    ...
                    <tr class="visible md:hidden ">
                        <td class=" border-slate-100  p-2 md:p-4 text-slate-500" colspan="2">Email:
                            {{ $usuario->email }}</td>
                    </tr>
                    <tr class="visible md:hidden ">
