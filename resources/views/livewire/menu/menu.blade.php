<div>
    ...
    <div class=" bg-whitem pb-28 mt-2 container mx-auto rounded-md shadow-sm ">
        {{-- DATOS DEL NEGOCIO --}}
        <div class="w-full my-3 grid grid-cols-6 md:grid-cols-12 border-b border-blue-100 gap-1">
            ...
            <div class=" col-span-4 md:col-span-9 mx-auto  ">
                <div class="text-center font-Lobster   mt-3 text-2xl md:text-4xl text-gray-700 font-bold">
                    {{ $negocio->name }}
                </div>
            </div>
        </div>
    ...
    {{-- 3  datos del negocio --}}
    <div
        class="  grid  grid-cols-2 mx-auto border-t-2 border-indigo-300 bg-black fixed bottom-0 w-full p-2 text-white ">
        <div>
        ...
        <div>
            ...
            <div class="text-left mb-2 text-xs font-bold">
                Tlf:{{ $negocio->telefono2 }}
            </div>
        </div>
        <div class="col-span-2 mx-auto text-xs">
            designer by Angel Charlot
        </div>
